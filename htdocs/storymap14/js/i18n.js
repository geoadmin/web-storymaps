...
var myi18n = {
    ...
    'fr': {
        ...
        "Zusammenfassung": "Le 18 avril 1991, un éboulement de quelque 15 millions m3 de roche s'est déclenché près de Randa dans la haute vallée de Zermatt. " + "Des blocs de pierre, certains grands comme une maison, ont dévalé la pente sur 600m. " + "Ce sont principalement les périodes de gel et de dégel et la pression élevée de l'eau dans les fissures de la roche qui sont à l'origine de l'éboulement de la montagne. " + "Le 9 mai de la même année, il s'est à nouveau produit près de Randa un éboulement de plusieurs millions de m3 de matériaux rocheux (Carte: Carte Siegfried 1881; ",
    ...
    'it': {
        ...
        "Zusammenfassung": "Il 18 aprile 1991, nei pressi di Randa, che si trova nella parte più interna della valle di Zermatt, crollarono circa 15 milioni di m3 di roccia. " + "Alcuni blocchi di roccia, caduti per più di 600 metri, erano grandi quasi quanto delle case unifamiliari. " + "Il 9 maggio dello stesso anno, nuovamente presso Randa si verificò un secondo crollo di alcuni milioni di metri cubi di roccia (Carta Siegfried 1881; ",
